...
package conversordemoedas.java;
...
public class conversor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BRL", }));

        txtTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "EUR" }));
    ...
    private void ConvertActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(txtFrom.getSelectedItem().toString()=="BRL" && txtTo.getSelectedItem().toString()=="USD"){
            convert = amount * 04.91;
            JOptionPane.showMessageDialog(this, "O valor é: "+convert.toString()+" DÓLARES.");
        }
        else if(txtFrom.getSelectedItem().toString()=="BRL" && txtTo.getSelectedItem().toString()=="EUR"){
            convert = amount * 05.25;
            JOptionPane.showMessageDialog(this, "O valor é: "+convert.toString()+" EUROS.");
        }
        else if(txtFrom.getSelectedItem().toString()=="EUR" && txtTo.getSelectedItem().toString()=="USD"){
            convert = amount * 1.07;
            JOptionPane.showMessageDialog(this, "O valor é: "+convert.toString()+" DÓLARES.");
        }
         else if(txtFrom.getSelectedItem().toString()=="EUR" && txtTo.getSelectedItem().toString()=="BRL"){
            convert = amount * 05.25;
            JOptionPane.showMessageDialog(this, "O valor é: "+convert.toString()+"  REAIS.");
        }
